/**
 * HomeView: Pantalla de selección de rol
 * El dispositivo recuerda el rol elegido en localStorage
 */
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="ml-auto text-orange-200 opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all">
              →
            </div>
          </div>
        </button>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-slate-400 text-sm mt-0.5">
                Recibir avisos de cocina
              </div>
            </div>
            <div className="ml-auto text-slate-500 opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all">
              →
            </div>
          </div>
        </button>
