 ...
 * Aparece cuando una mesa está lista y el mozo debe confirmar
 */
  ...
  return (
    <div className="slide-up alert-pulse bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-6 text-white shadow-2xl shadow-orange-500/50 border border-orange-400/30">
      ...
      <div className="flex items-center justify-center gap-2 mb-4">
        ...
        <p className="text-orange-100 font-semibold text-xs uppercase tracking-widest">
          Pedido Listo 🍽️
        </p>
      </div>
      ...
      <div className="text-center my-4">
        ...
        <p className="text-orange-100 text-lg font-bold mt-2">
          Mesa {tableNumber} Lista
        </p>
